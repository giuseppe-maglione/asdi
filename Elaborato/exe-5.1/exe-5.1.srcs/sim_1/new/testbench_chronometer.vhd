...
architecture Structural of tb_chronometer is
    ...
    signal tmp_tb: std_logic;
    signal rst_tb: std_logic := '0';
    signal start_tb: std_logic := '0';
    
    signal set_tb: std_logic := '0'; 
    signal set_hh_tb: std_logic_vector(4 downto 0) := (others => '0');
    signal set_mm_tb: std_logic_vector(5 downto 0) := (others => '0');
    signal set_ss_tb: std_logic_vector(5 downto 0) := (others => '0');
