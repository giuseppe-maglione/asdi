...
entity tb_shift_rec_generic is
end tb_shift_rec_generic;

architecture Behavioral of tb_shift_rec_generic is

    -- dichiarazione dello shift register
    component shift_rec_generic
        generic (
            N: natural := 8
        );
        port (
